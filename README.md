...
cd pilot
# change from SQLite to PostgreSQL in your .env just set DATABASE_TYPE=postgres
python db_init.py
python main.py
```

## Start from existing app

```bash
If you wish to continue with this project in future run:
python main.py app_id=3d8988bd-041b-4f00-91e8-73b59e179b53
```

- title: data-store-login 

create a postgre database for storing, acessing, editing and amending text
create a title field from 2 to 120 characters
create a text field from 2 to 10000 characters
Access and edit the text from a website
allow one user called admin to access the database
use bearer token authentication
use nginx and express to serve the website
allow admin to search, edit and append data
use bootstrrap to create a front end
include a login page
include a search page
include a edit page
include a append page
include a delete page
include a logout page
add unit tests for login
PeeWee ORM is used to connect to the database and already installed
